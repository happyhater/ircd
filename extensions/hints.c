...
static hint hints[] = {
    {
        "[info] channel flooding and no channel staff around to help? Contact staff: `/stats p`, or drop by #help !",
        NULL,
        1,
        1
    },
    {
        "[info] channel trolls and no channel staff around to help? `/stats p`, or drop by #help !",
        NULL,
        1,
        1,
    },
    {
        "[info] if you're at a conference and other people are having trouble connecting, please mention it to staff: `/stats p`, or drop by #help !",
        NULL,
        1,
        1
    }
/*    {
        "[info] why register and identify? your IRC nick is how people know you.",
        NULL,
        0,
        1
    },
    {
        "[info] please register your nickname...don't forget to auto-identify!",
        NULL,
        0,
        1,
    },
    {
        "[info] help our network to weed out clonebots -- please register your IRC nick and auto-identify.",
        NULL,
        0,
        1
    }*/
